                            ...
                            mailparser.simpleParser(stream, function (err, mail) {
                                ...
                                if (mail.text) {
                                    if(data.user.endsWith("@sina.com")) {
                                        ...
                                        markString = "<td class=\"paragraph\" style=\"padding:0 5% 18px;font:300 14px/18px 'Lucida Grande', Lucida Sans, Lucida Sans Unicode, sans-serif, Arial, Helvetica, Verdana, sans-serif;color:#333;\"><a href=\"";
                                        markString2 = "\" style=\"line-height:18px;color:#08c;text-decoration:none;\">立即验证";
                                        markIndex = mail.text.indexOf(markString) + markString.length;
                                        markIndex2 = mail.text.indexOf(markString2) - markString2.length;
                                    }
                                    result = mail.text.substring(markIndex, markIndex2);
